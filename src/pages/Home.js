...
class Home extends React.Component {
  ...
  render() {
    ...
    const drawer = <Tree onClickItem={this.setCurrentPageID} />;
      ...
      <div className={classes.root}>
        ...
        <AppBar position="fixed" className={classes.appBar}>
          <Toolbar>
            ...
            <NewPageDialog open={this.state.isNewPageDialogOpen} parentID={this.state.currentPageID} onClose={this.toggleNewPageDialog} />
            <NewWorkspaceDialog open={this.state.isNewWorkspaceDialogOpen} onClose={this.toggleNewWorkspaceDialog} />
        ...
        <main className={classes.content}>
          ...
          <Typography paragraph>
            ...
            vel. Risus at ultrices mi tempus imperdiet. Semper risus in hendrerit gravida rutrum quisque non tellus. Convallis convallis tellus id interdum velit laoreet id donec ultrices. Odio morbi
            quis commodo odio aenean sed adipiscing. Amet nisl suscipit adipiscing bibendum est ultricies integer quis. Cursus euismod quis viverra nibh cras. Metus vulputate eu scelerisque felis
            imperdiet proin fermentum leo. Mauris commodo quis imperdiet massa tincidunt. Cras tincidunt lobortis feugiat vivamus at augue. At augue eget arcu dictum varius duis at consectetur lorem.
